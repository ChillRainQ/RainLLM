...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project", type=str, default="RainLLM-Pretrain")
    ...
    lm_config = RainLLMConfig(dim=args.dim, n_layers=args.n_layers, max_seq_len=args.max_seq_len)
    ...
    args.wandb_run_name = f"RainLLM-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
